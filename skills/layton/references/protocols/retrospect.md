---
name: retrospect
description: Reflect on a completed protocol to identify improvements and capture changes
triggers:
  - retrospect
  - reflect on protocol
  - protocol feedback
...
<objective>
Guide structured reflection on a protocol that was just executed, identify what worked and what didn't, and optionally capture improvements to the protocol file.
</objective>

<prerequisites>
A protocol should have been recently completed in this session.
</prerequisites>
...
> "What protocol did we just complete? (e.g., 'setup', 'morning-briefing', or describe what we did)"

Accept either:

- Protocol name (e.g., "setup")
...
> "Did the protocol achieve its goal?"
>
...
> "What felt awkward, slow, or confusing during the protocol?"
>
> Examples:
>
...
> "Would you like me to draft edits to the protocol file based on this feedback?
>
...
> "No problem! Your feedback is noted. You can always update the protocol later or run this retrospect again."
...
- **If protocol was successful**: Keep it brief, ask if there's anything to improve anyway
- **If protocol had issues**: Dig deeper into specifics, offer to fix
- **If user is frustrated**: Acknowledge the frustration, focus on constructive improvements
- **If it's a new protocol**: Feedback is especially valuable—suggest capturing learnings
</context_adaptation>
